...
if __name__=="__main__":
    ...
    spatial_boundaries_ri = "PSPUS_2016_FINAL_1_Reprojected.shp"
    ...
    external_spatial_data = [historicFire, historicHarvest, NAmat, spatialBoundaries]
    ...
    clip = [historicFire, historicHarvest]
